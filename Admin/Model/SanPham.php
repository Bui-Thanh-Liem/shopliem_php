...
class SanPham
{
    ...
    function insertSanPham($tenhh, $maloai, $gia_sanPham, $giam_gia, $slx, $ngaylap, $mota)
    {
        $db = new Connect();
    ...
    {
        $db = new Connect();
        $select = "SELECT sp.ten_sanPham, sp.id_loaiSanPham, ctsp.phanTramGiaGia_sanPham, ctsp.mieuTa_sanPham, ctsp.ngayLap, ctsp.luotXem, ctsp.gia_sanPham
                    FROM san_pham sp, chi_tiet_san_pham ctsp 
    ...
    function updateSanPham($mahh, $tenhh, $maloai, $gia_sanPham, $giam_gia, $slx, $ngaylap, $mota)
    {
        $db = new Connect();
        $query1 = "UPDATE san_pham
                    SET ten_sanPham = '$tenhh', id_loaiSanPham = $maloai
                    WHERE san_pham.id_sanPham = $mahh";
