...
class SanPham
{
    function laySanPhamMoi()
    {
        ...
        $select = "SELECT sp.ten_sanPham, sp.hinh_sanPham, ctsp.gia_sanPham, ctsp.phanTramGiaGia_sanPham
                    FROM san_pham sp, chi_tiet_san_pham ctsp 
                    WHERE sp.id_sanPham = ctsp.id_sanPham ORDER BY sp.id_sanPham DESC LIMIT 4";
    ...
    function laySanPhamGiamGia()
    {
        ...
        $select = "SELECT sp.ten_sanPham, sp.hinh_sanPham, ctsp.gia_sanPham, ctsp.phanTramGiaGia_sanPham
                    FROM san_pham sp, chi_tiet_san_pham ctsp 
                    WHERE sp.id_sanPham = ctsp.id_sanPham AND ctsp.phanTramGiaGia_sanPham > 0 ORDER BY sp.id_sanPham DESC LIMIT 4";
    ...
    function layTatCaSanPhamGiamGia() {
        ...
        $select = "SELECT sp.id_sanPham, sp.ten_sanPham, sp.hinh_sanPham, ctsp.gia_sanPham, ctsp.phanTramGiaGia_sanPham
                    FROM san_pham sp, chi_tiet_san_pham ctsp
                    WHERE sp.id_sanPham = ctsp.id_sanPham AND ctsp.phanTramGiaGia_sanPham != 0";
    ...
    function laySanPhamTheoIdLoai($id) {
        ...
        $select = "SELECT sp.id_sanPham, sp.ten_sanPham, sp.hinh_sanPham, ctsp.gia_sanPham, ctsp.phanTramGiaGia_sanPham
                    FROM san_pham sp, chi_tiet_san_pham ctsp
                    WHERE sp.id_sanPham = ctsp.id_sanPham AND sp.id_loaiSanPham = $id";
    ...
    function layMotSanPhamTheoId($id) {
        ...
        // b2: viết câu truy vấn
        $select = "SELECT sp.ten_sanPham, sp.hinh_sanPham, ctsp.gia_sanPham, ctsp.phanTramGiaGia_sanPham, ctsp.mieuTa_sanPham
                    FROM san_pham sp, chi_tiet_san_pham ctsp
